...
\usepackage{hyperref}
\hypersetup{
    % urlbordercolor=1 1 1,S % set the outline of URL references
...
% TODO: wodurch sind in den Versionen Verbeserungen aufgetreten?
\section{Fazit}
% Ergebniszusammenfassung & Ausblick
% TODO: CSS Pruning, Automatisiertes Treeshaking, "Minimize main thread work", Preloading LCP-Bild, Effizienteres Caching mit CDN, Größere Bildversionen für große Bildschirme
...
\begin{table}[h]
  \begin{tabular}{|l|l|l|l|l|l|l|l|l|l|}
    ...
    \hline
    v01 & 2737 KB & 2964 ms & 4368 ms & 57 & 3300 ms & 3300 ms & 5100 ms & 14500 ms & 0 \\ % TODO: check CLS
    \hline
    ...
    \hline
    v10 & 628 KB & 2243 ms & 2125 ms & 44 & 900 ms & 4100 ms & 3900 ms & 3900 ms & 0,781 \\ % TODO: check Score, LCP und SI
    \hline
